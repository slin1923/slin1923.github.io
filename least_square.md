...
<figure align="center">
  <img src="/assets/images/meaningless_LS.jpg" width="400">
</figure>
...
- for the curious, the right-pseudoinverse also exists for the dual of the Least-Squares problem: the **Least-Norm problem** (which seeks to minimize $||x||$ for the infinitely possible solns.)  perhaps one day this far less common problem finds its way into these notes. 
